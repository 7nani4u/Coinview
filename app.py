...
- 🔤 글씨 크기 향상: 9pt → 11pt (가독성 향상)
- 🎯 완벽한 5단계 표시: 매우공포, 공포, 중립, 탐욕, 매우탐욕
- ✅ 모든 라벨 명확히 표시
    ...
    fig = go.Figure(go.Indicator(
        ...
        gauge={
            'axis': {
                ...
                'ticktext': ['매우<br>공포', '공포', '중립', '탐욕', '매우<br>탐욕'],
                'tickfont': {'size': 11, 'color': '#666666', 'family': 'Malgun Gothic, Arial, sans-serif'}
            },
