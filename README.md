...
- 롱·숏 방향에 맞춰 반전되는 1·2차 ATR 진입 구간과 손절가
- Binance 펀딩비·전체 계정 롱숏 비율·ADL 위험 및 실시간 청산 규모
...
- Binance WebSocket 실시간 시세와 브라우저 저장 기반 관심 코인 포트폴리오
- 영문 코인 뉴스 헤드라인 자동 한글 번역
...
| 펀딩비·롱숏 비율·ADL 위험 | Binance USDⓈ-M Futures 공개 API |
| 실시간 시세·청산 주문 | Binance Spot/Futures WebSocket |
